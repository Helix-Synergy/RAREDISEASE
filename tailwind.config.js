...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        /* Brand colors – updated to #cd3d3d */
        one: "#cd3d3d",        // Main brand color
        accent: "#cd3d3d",
        greenBrand: "#cd3d3d",
        ...
        /* Supporting / UI */
        sky: "rgba(205, 61, 61, 0.1)",    // Very light highlight
        orange: "rgba(205, 61, 61, 0.4)", // Muted secondary highlight
        lightGreen: "rgba(205, 61, 61, 0.2)", // Pastel background
