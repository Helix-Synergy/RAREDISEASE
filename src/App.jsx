  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/raredisease-orators"element={<Orators />} />
        <Route path="/about-raredisease" element={<AboutOralMed />} />
        <Route path="/raredisease-event-schedule"element={<EventSchedule />} />
