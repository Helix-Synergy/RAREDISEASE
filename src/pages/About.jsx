...
The International Rare Disease & Orphan Drug Congress, organized by Helix Conferences, is a distinguished international forum dedicated to advancing rare disease research, orphan drug development, and next-generation therapeutic solutions that support patient care, clinical outcomes, and <Link to="/raredisease-orators"className="
             hover:text-accent hover:decoration-accent
             transition-colors duration-300">
       global healthcare innovation.</Link> The congress is designed to facilitate high-level knowledge exchange, interdisciplinary collaboration, and evidence-based discussions that accelerate the translation of research into effective therapies. Emphasis is placed on orphan drug discovery, gene and cell therapies, precision medicine, clinical trials, patient-centric approaches, and regulatory frameworks.
Through plenary sessions, keynote addresses, expert-led panels, technical workshops, and scientific research presentations, participants will gain strategic insights into emerging therapies, translational models, and evolving global healthcare policies.
      ...
      <>
        ...
        <Link
          to= "/raredisease-conference-tracks/"
          target="blank"
  ...
  join: [
    {
      ...
      // link: "/",
      suffix:
       "Join global leaders and innovators in shaping the future of rare disease treatment and orphan drug development..",
    },
  ],
highlights: [
  {
    ...
    description:
      "Engage with internationally recognized experts and thought leaders in rare disease research, orphan drug development, and patient-centric innovations.",
  },
  {
    title: "Technical Workshops & Expert Sessions",
    description:
      "Participate in in-depth sessions focused on drug discovery, gene and cell therapies, clinical trial design, and regulatory strategies for rare diseases.",
  },
  {
    title: "Innovation & Technology Exhibition",
    description:
      "Discover advanced therapeutic platforms, rare disease diagnostics, precision medicine solutions, and cutting-edge biotechnological innovations.",
  },
  {
    title: "Strategic Networking Opportunities",
    description:
      "Build meaningful connections with global stakeholders across academia, industry, government, and patient advocacy organizations.",
  },
  {
    title: "Patient-Centric & Regulatory Focus",
    description:
      "Gain insights into patient engagement frameworks, global orphan drug policies, and regulatory pathways for rare disease therapies.",
  },
  {
    title: "Scientific & Market Intelligence",
    description:
      "Explore the latest research findings, clinical trends, and commercialization strategies in rare disease and orphan drug development.",
    linkText: "View event schedule",
    link: "/raredisease-event-schedule",
  },
  {
    title: "Collaboration & Partnership Platforms",
    description:
      "Foster cross-sector partnerships to advance research, innovation, and scalable therapeutic solutions for rare diseases.",
  },
  {
...
Fostering Collaboration Driving Breakthroughs in Rare Disease Therapeutics
      </h1>
      ...
      <section className="mb-10 text-center w-full min-w-4xl px-2 md:px-12 lg:px-24">
        <h2 className="text-3xl font-bold text-one mb-4 w-full">
          Join the Global Community at on RAREDISEASE-2026
        </h2>
      ...
      Rare Disease Researchers and Clinical Scientists
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
            <BookOpen className="h-10 w-10 text-one mb-3" />
            <h3 className="text-lg font-semibold text-gray-800 mb-1">
Biopharmaceutical and Biotechnology Professionals
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
            <Rocket className="h-10 w-10 text-one mb-3" />
            <h3 className="text-lg font-semibold text-gray-800 mb-1">
AI, Data Analytics, and Translational Medicine Experts
            </h3>
          </div>
          <div className="bg-white rounded-xl shadow px-4 py-6 flex flex-col items-center hover:shadow-lg transition">
            <PackageSearch className="h-10 w-10 text-one mb-3" />
            <h3 className="text-lg font-semibold text-gray-800 mb-1">
   Healthcare Providers, Patient Advocates, and Policy Leaders
            </h3>
          </div>
        </div>
      </section>
